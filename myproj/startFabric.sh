...
./network.sh deployCC -ccn mychain -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH} 
# peer lifecycle chaincode package mychain.tar.gz --path ../chaincode/fabcar/javascript/ --lang node --label mychain_1.0
